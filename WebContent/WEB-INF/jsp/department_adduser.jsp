		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<form action="${pageContext.request.contextPath}/Department/department_addUser.action">
						<div class="panel-heading">&nbsp;&nbsp;
						 
						&nbsp;&nbsp;
						<input class="btn btn-danger btn-xs" type= "submit" value = "提交"/>
						<!-- <a href="#" class="btn btn-danger btn-xs">提交</a>
						 -->
					<input type="text" name="department_id" value="${department_id}" style="display: none;"/>
						</div>											
						<!-- /.panel-heading -->
								...
								<c:forEach items="${page}" var="row">
									<tr style="text-align: center;">
										...
										<td>
											...
											<a href="${pageContext.request.contextPath }/#.action?workflow_id=${row.user_id}" class="btn btn-danger btn-xs">删除</a>
										</td>
									</tr>
								</c:forEach>
						</tbody>
