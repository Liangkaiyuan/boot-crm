...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">未完成流程管理</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
							...
							<tbody>
								<c:forEach items="${page}" var="row">
									...
									<td>${row.workflow_id}</td>
									    ...
									    <td>${row.workflow_data_createtime}</td>
										<td>
										<a href="${pageContext.request.contextPath }/workflow/Approval_showWorkflowdate.action?workflow_id=${row.workflow_id}" class="btn btn-danger btn-xs">审批节点信息${row.workflow_id}</a>
											
											<a href="${pageContext.request.contextPath }/workflow/notFinishworkflowdataIn.action?workflow_data_id=${row.workflow_data_id}&workflow_id=${row.workflow_id}" class="btn btn-danger btn-xs">进入</a>
