			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">审批节点信息</div>
						<!-- /.panel-heading -->
							...
							<tbody>
								<c:forEach items="${page}" var="row">
									<tr style="text-align: center;">
										<td>${row.node_approve_start}</td>
										<td>${row.node_approve_one}</td>
										<td>${row.node_approve_two}</td>
										<td>${row.node_approve_three}</td>
										<td>${row.node_approve_four}</td>
										<td>${row.node_approve_five}</td>
										<td>${row.node_approve_end}</td>
										 
										<%-- <td>${row.workflow_s eq 1 ? '是':'否'}</td> --%>
										 
										<td>
											<a href="${pageContext.request.contextPath }/#" class="btn btn-danger btn-xs">编辑</a>
											<a href="${pageContext.request.contextPath }/#" class="btn btn-danger btn-xs">删除</a>
										</td>
									</tr>
								</c:forEach>
						</tbody>
