...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">创建流程(有效)</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
							...
							<tbody>
								<c:forEach items="${page}" var="row">
									<tr>
										...
										<td>
											<a href="${pageContext.request.contextPath }/workflow/onelist.action?workflow_id=${row.workflow_id}" class="btn btn-danger btn-xs">新建</a>
											<a href="${pageContext.request.contextPath }/showapproval.action?workflow_id=${row.workflow_id}" class="btn btn-danger btn-xs">审批节点信息</a>
