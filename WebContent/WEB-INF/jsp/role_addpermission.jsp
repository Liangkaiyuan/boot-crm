...
var checkAll = false;
function allcheck() {
    let inputs = document.getElementsByName('head_id');
    var checkInt = 0;
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<form action="${pageContext.request.contextPath}/role_addPermission.action">
								...
								<c:forEach items="${head}" var="row">
									...
									<input type="text" name="role_id" value="${role_id}" style="display: none;"/>
										...
										<td>
											...
											<a href="${pageContext.request.contextPath }#.action?user_id=${user_id}&role_id=${user_roleid}" class="btn btn-danger btn-xs">删除</a>
										</td>
									</tr>
								</c:forEach>
						</tbody>
