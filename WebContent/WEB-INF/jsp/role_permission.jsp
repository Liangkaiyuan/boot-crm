		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<form action="${pageContext.request.contextPath }/role_deletePermission.action">
						<div class="panel-heading">&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/Role_toaddPermission.action?role_id=${role_id}" class="btn btn-danger btn-xs">${role_id}添加权限</a> &nbsp;&nbsp; <input class="btn btn-danger btn-xs" type= "submit" value = "批量删除"/></div>											
						...
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<c:forEach items="${head}" var="row">
									<tr style="text-align: center;">
									<td><input type="checkbox" name="head_id" value="${row.head_id}"><br></td>
									<input type="text" name="role_id" value="${role_id}" style="display: none;"/>
										<td>${row.head_id}</td>
										<td>${row.head_name}</td>
										<td>${row.head_url}</td>
										<td>
											<a href="${pageContext.request.contextPath }#.action?userid=${ruser_id}" class="btn btn-danger btn-xs">编辑</a>
											<a href="${pageContext.request.contextPath }/role_deletePermission.action?role_id=${role_id}&head_id=${row.head_id}" class="btn btn-danger btn-xs">删除</a>
										</td>
									</tr>
								</c:forEach>
						</tbody>
