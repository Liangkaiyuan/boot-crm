			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">角色管理  &nbsp;<a href="${pageContext.request.contextPath }/toaddRole.action" class="btn btn-danger btn-xs">添加角色</a>
						</div>
						<!-- /.panel-heading -->
							...
							<tbody>
								<c:forEach items="${page}" var="row">
									<tr>
										...
										<td>
											<a href="${pageContext.request.contextPath }/#.action?workflow_id=${row.role_id}" class="btn btn-danger btn-xs">编辑</a>
											
											<a href="${pageContext.request.contextPath }/Role_userList.action?role_id=${row.role_id}" class="btn btn-danger btn-xs">用户管理</a>
											
											<a href="${pageContext.request.contextPath }/role_permission.action?role_id=${row.role_id}" class="btn btn-danger btn-xs">授权</a>
											
											<a href="${pageContext.request.contextPath }/deleteRole.action?role_id=${row.role_id}" class="btn btn-danger btn-xs">${row.role_id}删除</a>
										</td>
									</tr>
								</c:forEach>
						</tbody>
...
<input style="display: none;" id="erro" type="text" value="${erro}" />
<input style="display: none;" id="success" type="text" value="${success}" />
