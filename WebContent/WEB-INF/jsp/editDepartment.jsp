...
<jsp:include page="/WEB-INF/jsp/head.jsp" /> 
        ...
        <h4 style="text-align: center;">修改部门</h4>
          <c:forEach items="${department}" var="row">
			<form action="${pageContext.request.contextPath }/Department/editDepartment.action" method="post">
				 <input type="text" id="value" name="department_name" placeholder="${row.department_id}" autocomplete = "off"/>
	                      部门名称：<input type="text" id="value" name="department_name" placeholder="${row.department_name}" autocomplete = "off"/><br /> <br /> 
			 主管级：<input type="text" id="value1" name="department_name" placeholder="${row.department_zhuguanji}" autocomplete = "off"/><br /> <br /> 
			 经理级：<input type="text" id="value2" name="department_name" placeholder="${row.department_jingliji}" autocomplete = "off"/><br /> <br /> 
			 总监级：<input type="text" id="value3" name="department_name" placeholder="${row.department_zongjianji}" autocomplete = "off"/><br /> <br /> 
			 副总经理：<input type="text" id="value4" name="department_name" placeholder="${row.department_fuzongjingliji}" autocomplete = "off"/><br /> <br /> 
			 总经理：<input type="text" id="value5" name="department_name" placeholder="${row.department_zongjingliji}" autocomplete = "off"/><br /> <br /> 
